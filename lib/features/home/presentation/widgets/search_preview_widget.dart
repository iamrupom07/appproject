        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: const [
                _CategoryChip(label: 'Excavators', selected: true),
                SizedBox(width: 8),
                _CategoryChip(label: 'Wheel Loaders'),
                SizedBox(width: 8),
                _CategoryChip(label: 'Bulldozers'),
                SizedBox(width: 8),
                _CategoryChip(label: 'Du...'),
              ],
            ),
          ),
            ...
            child: Column(
              children: const [
                ...
                _MachineListCard(
                  ...
                  name: 'CAT 320 GC',
                  subtitle: 'Speak directly with our\nequipment experts.',
                  price: r'$ 125,000',
                ),
              ],
            ),
